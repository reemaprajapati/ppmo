...
import com.example.otimus.ppmo.rest.ApiInterfaceOtherServices;
...
public class FragmentOtherServices extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ApiInterfaceOtherServices apiInterface= ApiClient.getClient().create(ApiInterfaceOtherServices.class);
        Call<List<TenderItem>> call=apiInterface.getOtherServices();
