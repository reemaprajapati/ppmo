...
import com.example.otimus.ppmo.rest.ApiInterfaceWorks;
...
public class FragmentWorks extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ApiInterfaceWorks apiInterface= ApiClient.getClient().create(ApiInterfaceWorks.class);
        Call<List<TenderItem>> call=apiInterface.getWorks();
